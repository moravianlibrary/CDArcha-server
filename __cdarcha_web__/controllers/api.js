...
exports.postTwitter = (req, res, next) => {
  ...
  if (errors) {
    ...
    return res.redirect('/cdarcha/api/twitter');
  }
  ...
  T.post('statuses/update', { status: req.body.tweet }, (err) => {
    ...
    res.redirect('/cdarcha/api/twitter');
  });
};
*/
...
exports.postStripe = (req, res) => {
  ...
  stripe.charges.create({
    ...
    if (err && err.type === 'StripeCardError') {
      ...
      return res.redirect('/cdarcha/api/stripe');
    }
    req.flash('success', { msg: 'Your card has been successfully charged.' });
    res.redirect('/cdarcha/api/stripe');
  });
};
*/
...
exports.postTwilio = (req, res, next) => {
  ...
  if (errors) {
    req.flash('errors', errors);
    return res.redirect('/cdarcha/api/twilio');
  }
  ...
  twilio.messages.create(message).then((sentMessage) => {
    ...
    res.redirect('/cdarcha/api/twilio');
  }).catch(next);
};
*/
...
exports.postClockwork = (req, res, next) => {
  ...
  clockwork.sendSms(message, (err, responseData) => {
    ...
    res.redirect('/cdarcha/api/clockwork');
  });
};
*/
...
exports.postFileUpload = (req, res) => {
  ...
  res.redirect('/cdarcha/api/upload');
};
...
exports.postPinterest = (req, res, next) => {
  ...
  if (errors) {
    req.flash('errors', errors);
    return res.redirect('/cdarcha/api/pinterest');
  }

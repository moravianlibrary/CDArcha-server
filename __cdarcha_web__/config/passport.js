...
passport.use(new FacebookStrategy({
  ...
  callbackURL: '/cdarcha/auth/facebook/callback',
...
passport.use(new GitHubStrategy({
  ...
  callbackURL: '/cdarcha/auth/github/callback',
  passReqToCallback: true
}, (req, accessToken, refreshToken, profile, done) => {
  if (req.user) {
...
passport.use(new TwitterStrategy({
  ...
  callbackURL: '/cdarcha/auth/twitter/callback',
  passReqToCallback: true
...
passport.use(new GoogleStrategy({
  ...
  callbackURL: '/cdarcha/auth/google/callback',
  passReqToCallback: true
}, (req, accessToken, refreshToken, profile, done) => {
  if (req.user) {
...
passport.use(new InstagramStrategy({
  ...
  callbackURL: '/cdarcha/auth/instagram/callback',
  passReqToCallback: true
}, (req, accessToken, refreshToken, profile, done) => {
  if (req.user) {
...
passport.use('tumblr', new OAuthStrategy({
  ...
  callbackURL: '/cdarcha/auth/tumblr/callback',
  passReqToCallback: true
},
...
exports.isAuthorized = (req, res, next) => {
  ...
  if (token) {
    ...
    res.redirect(`/cdarcha/auth/${provider}`);
  }
};
